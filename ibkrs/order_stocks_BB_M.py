...
if __name__ == "__main__":
    ...
    print("Authentication started for {} accounts...".format(USERNAME))
    usernames = [USERNAME]
    passwords = [PASSWORD]

    accounts = hp.get_authenticated_accounts(usernames, passwords)
    ...
    auth_status = False
    if args.passkey:
        ib_client, auth_status = hp.reauthenticate_ib_client(ib_client)
